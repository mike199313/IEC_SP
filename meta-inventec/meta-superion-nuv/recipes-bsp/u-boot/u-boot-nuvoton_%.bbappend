FILESEXTRAPATHS:prepend:superion-nuv := "${THISDIR}/u-boot-nuvoton:"

UBOOT_MAKE_TARGET:append:superion-nuv = " DEVICE_TREE=${UBOOT_DEVICETREE}"

SRC_URI:append:superion-nuv =     " file://fixed_phy.cfg \
